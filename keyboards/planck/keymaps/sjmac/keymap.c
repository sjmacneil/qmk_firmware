...
[_GAME] = LAYOUT_planck_grid(
    ...
    KC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,   KC_G,    KC_H,    KC_J,   KC_4,    KC_5,    KC_6,  KC_ESC,
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,   KC_B,    KC_N,    KC_M,   KC_1,    KC_2,    KC_3,  KC_ENT ,
    KC_LCTL, KC_LGUI, KC_LALT, KC_SPC,  LOWER,  KC_SPC,  KC_SPC,  RAISE,  KC_LEFT, KC_DOWN, KC_UP, KC_RGHT
),
